...
<div class="container-self">
  ...
  <nav class="sidebar-self">
    ...
    <div class="menu-item active" data-page="current" onclick="window.location.href='current.jsp'">当前借阅</div>
    <div class="menu-item" data-page="records" onclick="window.location.href='records.jsp'">借阅记录</div>
  </nav>

  <!-- 右侧内容区 -->
  <main class="content">
    <h2 class="page-title">当前借阅</h2>
    <div id="page-content"  style="height: calc(100vh - 100px);">
      <form action="../book/searchBorrowed" method="get" target="borrowedFrame">
        <label for="book_name">图书名称：</label>
        <input type="text" id="book_name" name="book_name">
        &nbsp;
        <label for="book_author">图书作者：</label>
        <input type="text" id="book_author" name="book_author">
        &nbsp;
        <label for="book_press">出版社：</label>
        <input type="text" id="book_press" name="book_press">
        <button type="submit" class="btn btn-primary">查询</button>
      </form>

      <iframe width="100%" height="100%" id = "borrowedFrame" name="borrowedFrame">
      </iframe>
    </div>
