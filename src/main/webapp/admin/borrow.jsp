...
<div class="container-self">
    ...
    <nav class="sidebar-self">
        ...
        <div class="menu-item active" data-page="borrow" onclick="window.location.href='borrow.jsp'">图书借阅</div>
    ...
    <main class="content">
        ...
        <div>
            ...
            <c:if test="${sessionScope.USER_SESSION.role != 'admin'}">
                <button type="button" class="btn btn-dark"
                        data-bs-toggle="modal"
                        data-bs-target="#newModal" disabled>
                    新增2
                </button>
            </c:if>
        ...
        <div id="page-content"  style="height: calc(100vh - 100px);">
            <form action="../book/search" method="get" target="resultFrame">
            ...
            <iframe width="100%" height="100%" id = "resultFrame" name="resultFrame">
            </iframe>
        </div>
